...
const creatUserTable = ';DROP TABLE IF EXISTS users CASCADE; CREATE TABLE users(id SERIAL PRIMARY KEY NOT NULL, firstName VARCHAR(100) NOT NULL, lastName VARCHAR(100) NOT NULL, role VARCHAR(100) NOT NULL, email VARCHAR(100) NOT NULL, password VARCHAR(400) NOT NULL, department VARCHAR(100), joined TIMESTAMP)'
